...
In {\sf PCStream}, we employ a simple but effective workaround 
...
\vspace{-5pt}
The last step in PCStream is to map
...
as shown in Fig. 5(b)-(c), the lifetime distributions of per-level compaction steps 
...
For such a PC (e.g. compaction-activity PC {\it pID}), {\sf PCStream} roughly assigns a
...
we move the long-lived data of sID to its substream during garbage collection.   
