...
\vspace{-7pt}
\hfill
\subfloat[compaction: all levels]{\includegraphics[width=0.22\textwidth]{figure/pc_3b}}
\subfloat[compaction: L2]{\includegraphics[width=0.22\textwidth]{figure/type_4b}}  % data from 4/03040047
\hfill
\vspace{-10pt}
\subfloat[compaction: L3]{\includegraphics[width=0.22\textwidth]{figure/type_5b}}
\subfloat[compaction: L4] {\includegraphics[width=0.22\textwidth]{figure/type_6b}}
\vspace{-5pt}
