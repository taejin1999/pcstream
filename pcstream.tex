...
Data from L1 are likely to have shorter lifetimes, while L4 has generally
...
\vspace{-7pt}
\hfill
\subfloat[compaction: all levels]{\includegraphics[width=0.21\textwidth]{figure/pc_3}}
	\hspace{2pt}
\subfloat[compaction: L2]{\includegraphics[width=0.21\textwidth]{figure/type_4}}  % data from 4/03040047
\hfill
\vspace{-1pt}
\subfloat[compaction: L3]{\includegraphics[width=0.21\textwidth]{figure/type_5}}
	\hspace{2pt}
\subfloat[compaction: L4]{\includegraphics[width=0.21\textwidth]{figure/type_6}}
\vspace{-10pt}
