...
\begin{figure}[t]
	\centering
	\subfloat[abstracted execution path of flush.]{\includegraphics[width=0.45\textwidth]{figure/getpc_1}}  
	\vspace{-10pt}
	\hfill
	\subfloat[with frame pointer.]{\includegraphics[width=0.245\textwidth]{figure/getpc_2}}
	\subfloat[without frame pointer.]{\includegraphics[width=0.25\textwidth]{figure/getpc_3}}
	\vspace{-8pt}
