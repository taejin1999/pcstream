...
\hspace{1pt}
\hfill
	\subfloat[$M_{manual}$: logging]{\includegraphics[width=0.21\textwidth]{figure/type_1b}} % data from 4/03031953 
	\subfloat[$M_{automatic}$: logging]{\includegraphics[width=0.21\textwidth]{figure/pcID_2b}}
\hfill
\vspace{-10pt}
	\subfloat[$M_{manual}$: flushing] {\includegraphics[width=0.21\textwidth]{figure/type_3b}}
	\subfloat[$M_{automatic}$: flushing]{\includegraphics[width=0.21\textwidth]{figure/pcID_3b}}
\vspace{-10pt}
