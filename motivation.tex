...
\centering
\hspace{1pt}
\subfloat[manual: log]{\includegraphics[width=0.23\textwidth]{figure/type_1b}} % data from 4/03031953 
\subfloat[PC\#2]{\includegraphics[width=0.23\textwidth]{figure/pcID_2b}}
\hfill
\vspace{-10pt}
\subfloat[manual: flush] {\includegraphics[width=0.23\textwidth]{figure/type_3b}}
\subfloat[PC\#3]{\includegraphics[width=0.23\textwidth]{figure/pcID_3b}}
...
(\texttt{automatic}).  Fig.~\ref{fig:types_and_PCs} compares the lifetime
distributions of data that are separated by \texttt{manual} and
\texttt{automatic}.  Figs.~\ref{fig:types_and_PCs}(a) and (b) represent how
...
comparable to \texttt{manual}. Similarly, Figs.~\ref{fig:types_and_PCs}(c)
