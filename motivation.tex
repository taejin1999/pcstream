...
\vspace{-27pt}
\hfill
	\subfloat[Logging (PC)]{\includegraphics[width=0.21\textwidth]{figure/type_1b}} % data from 4/03031953 
	\subfloat[Logging (manual)]{\includegraphics[width=0.21\textwidth]{figure/pcID_2b}}
\hfill
\vspace{-10pt}
	\subfloat[Flushing (PC)] {\includegraphics[width=0.21\textwidth]{figure/type_3b}}
	\subfloat[Flushing (manual)]{\includegraphics[width=0.21\textwidth]{figure/pcID_3b}}
\vspace{-10pt}
