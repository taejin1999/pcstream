...
\vspace{-27pt}
\hfill
	\subfloat[Logging (PC)]{\includegraphics[width=0.22\textwidth]{figure/type_1}} % data from 4/03031953 
	\subfloat[Logging (manual)]{\includegraphics[width=0.22\textwidth]{figure/pcID_2}}
\hfill
\vspace{-10pt}
	\subfloat[Flushing (PC)] {\includegraphics[width=0.22\textwidth]{figure/type_3}}
	\subfloat[Flushing (manual)]{\includegraphics[width=0.22\textwidth]{figure/pcID_3}}
\vspace{-10pt}
